...
CREATE TABLE IF NOT EXISTS `bodegas` (
  ...
  KEY `fk_bodegas_productos_idx` (`idproducto`),
  CONSTRAINT `fk_bodegas_productos` FOREIGN KEY (`idproducto`) REFERENCES `productos` (`idproducto`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  `categoriacol` tinyint(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `productos` (
  ...
  `estado_bodega` varchar(20) COLLATE utf8_spanish2_ci DEFAULT NULL,
